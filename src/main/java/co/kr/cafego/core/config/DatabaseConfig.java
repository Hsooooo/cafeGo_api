...
public class DatabaseConfig{
	...
	// ?��?��_DB:real, 개발_DB:dev, 로컬_DB:local
//	private static String mode 	 =  SystemEnviroment.getActiveProfile();
	
	/*
	 * PROVIDER_URL : �? ?��버의 JEUS_ADMIN_ADDRESS:JEUS_ADMIN_BASE_LISTEN_PORT �? ?��?��
