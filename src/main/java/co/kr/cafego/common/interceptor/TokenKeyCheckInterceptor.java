...
import co.kr.istarbucks.common.util.DataCode;
import co.kr.istarbucks.common.util.ParamUtils;
import co.kr.istarbucks.common.util.ResultCode;
import co.kr.istarbucks.core.support.NaverTokenCheck;
...
//			logger.info("[토큰 체크] 정상 : " + remote_addr + " " + token + " " + user_id + " " + token_expire_date);
	...
	public void setAuthMapper(AuthMapper authMapper) { this.authMapper = authMapper; }
	public HpOauthMapper getHpOauthMapper() { return hpOauthMapper; }
	public void setHpOauthMapper(HpOauthMapper hpOauthMapper) { this.hpOauthMapper = hpOauthMapper; }
